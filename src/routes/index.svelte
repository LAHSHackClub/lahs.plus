...
<div class=" mx-auto">
	<div class="flex flex-wrap">
		<div class="flex flex-grow bg-white border-2 border-gray-300 rounded-lg shadow-lg p-10 justify-center">
			<h1 class="text-4xl font-semibold">Welcome to lahs.plus!</h1>
		</div>
	</div>
